...
{
    public interface IEventAttendanceApiService : IApiService<EventAttendanceResponse, CreateEventAttendanceRequest, UpdateEventAttendanceRequest, DeleteEventAttendanceRequest>
    {
        /// <summary>
